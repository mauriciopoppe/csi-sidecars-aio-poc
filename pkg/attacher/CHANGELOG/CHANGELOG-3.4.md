...
- The external-attacher now ignores changes in `VolumeAttachment.metadata.managedFields`, saving some CPU. ([#338](https://github.com/kubernetes-csi/csi-sidecars/pkg/attacher/pull/338), [@uzuku](https://github.com/uzuku))
- Updated Kubernetes libraries to 1.23.0. ([#339](https://github.com/kubernetes-csi/csi-sidecars/pkg/attacher/pull/339), [@humblec](https://github.com/humblec))
