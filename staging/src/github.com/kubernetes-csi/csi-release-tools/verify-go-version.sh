...
# SC1091: Not following: staging/src/github.com/kubernetes-csi/csi-release-tools/prow.sh was not specified as input (see shellcheck -x).
# shellcheck disable=SC1091
expected=$(. staging/src/github.com/kubernetes-csi/csi-release-tools/prow.sh >/dev/null && echo "$CSI_PROW_GO_VERSION_BUILD")
